...
class OpenBaseNumber:
    def __init__(self,base_chars:str,*args, **kwargs):
        assert len(set(base_chars)) == len(base_chars), "Duplicate characters in base!"
...
class Base36(OpenBaseNumber):
    def __init__(self):
        super().__init__("0123456789abcdefghijklmnopqrstuvwxyz")
    #---------------
#---------------
class Base62(OpenBaseNumber):
    def __init__(self):
        super().__init__("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")
    #---------------
#---------------